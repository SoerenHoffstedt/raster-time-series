...
struct GdalSourceWriter {
                                ...
                                Resolution fill_from, Resolution res_left_to_fill)
    {
        ...
        double clip_x1 = spatInfo.x1;
        double clip_y1 = spatInfo.y1;
        double clip_x2 = spatInfo.x2;
        double clip_y2 = spatInfo.y2;
...
OptionalDescriptor GDALSource::nextDescriptor() {
    ...
    // but if tile is out of bounds of original raster -> have to use fill_from, left_to_fill
